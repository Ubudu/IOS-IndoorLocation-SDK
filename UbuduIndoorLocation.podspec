Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/Ubudu/IOS-IndoorLocation-SDK.git", :tag => "v0.1" }
  s.vendored_frameworks = "UbuduIndoorLocationSDK.framework"
